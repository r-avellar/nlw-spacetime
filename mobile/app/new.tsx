  ...
  return(
    <ScrollView className="flex-1 px-8" contentContainerStyle={{ paddingBottom: bottom, paddingTop: top}}>
      ...
      <View className="mt-6 space-y-6">
        ...
        />   
        <TouchableOpacity className=' items-center rounded-full bg-green-500 px-5 py-2' activeOpacity={0.7} onPress={handleCreateMemory}>
          <Text className='font-alt text-sm uppercase font-black'>Salvar</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  )
