...
export function NewMemoryForm(){
  ...
  return(
    <form  onSubmit={handleCreateMemory} className="flex flex-1 flex-col gap-2">
        ...
        />
        <button type="submit" className="self-end className='inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600'">
          SALVAR
        </button>
      </form>
  )
